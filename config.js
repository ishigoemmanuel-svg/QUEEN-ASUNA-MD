...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "INCONNU~XD~P0JxUISY#5l1wy0KvxXjRHvBA2t5yNhG55JDYIIU9GnP6TRW7t3M",
...
BOT_NAME: process.env.BOT_NAME || "ANONYMOUS-DOMAIN-MD",
STICKER_NAME: process.env.STICKER_NAME || "ANONYMOUS-DOAMAIN-MD",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false", 
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "false",
OWNER_NUMBER: process.env.OWNER_NUMBER || "2349020434443",
OWNER_NAME: process.env.OWNER_NAME || "ANONYMOUS HACKER",
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ANONYMOUS DOMAIN*",
